...
function gameTicTacToe(event) {
    ...
    a3.classList.contains("X") && b2.classList.contains("X") && c1.classList.contains("X")) {
        ...
        whoWinsParr.classList.add("animate__zoomInDown")
...
function switchPlayers(event) {
    ...
    if (player == 1) {
        ...
        h2.classList.remove("animate__tada")
        h2.classList.add("animate__jello")
        h2.textContent = `The turn is for: ${name2}`
        //change style of the box
        event.target.style.backgroundColor = "#FFBD00"
        event.target.classList.add("animate__flip")
        ...
        player = 1;
        // change text of turn of player 
        h2.classList.add("animate__tada")
        h2.classList.remove("animate__jello")
...
function reStart(event) {
    ...
    whoWinsParr.classList.remove("animate__zoomInDown")
    ...
    for (let i = 0; i < boxes.length; i++) {
        ...
        boxes[i].textContent = ""
        boxes[i].classList.remove("animate__flip")
    }
    //for ties 
    counter = 0
    //animation
...
btnReset.addEventListener("click", () => {
    ...
    numScore1.textContent = ""
    numScore2.textContent = ""
    whoWinsParr.classList.remove("animate__zoomInDown")
    h2.textContent = `The turn is for:`
    h2.classList.remove("animate__tada")
    document.querySelector(".p-one").value = "Name"
    document.querySelector(".p-two").value = "Name"
